...
namespace DotNetCoreKoans.Koans
{
    ...
    public class AboutMethods : Koan
    {
        ...
        {
            // Assert.Equal(MethodWithVariableArguments, this.MethodWithVariableArguments("Cory", "Will", "Corey"));
        }
        ...
        {
            // Assert.Equal(this.LocalMethodWithVariableParameters, this.LocalMethodWithVariableParameters("Cory", "Will", "Corey"));
        }
